defmodule CodingAgent.Tools do
  ...
  - `coding_tools/2` - Full access tools (browser, read, write, edit, patch, bash, grep, find, ls, webfetch, websearch, todo, task, agent, mesh_mailbox, tool_auth, extensions_status)
  ...
  @doc """
  Get the default coding tools (browser, read, write, edit, patch, bash, grep, find, ls, webfetch, websearch, todo, task, agent, mesh_mailbox, tool_auth, extensions_status).
