defmodule LemonSkills.Entry do
  ...
  @doc """
  Cache normalized body text used for relevance matching.
  """
  @spec with_body_search_text(t(), String.t() | nil) :: t()
  def with_body_search_text(%__MODULE__{} = entry, body_search_text)
      when is_binary(body_search_text) do
    %{entry | body_search_text: body_search_text}
  end

  def with_body_search_text(%__MODULE__{} = entry, _body_search_text) do
    %{entry | body_search_text: ""}
  end
