defmodule LemonControlPlane.Methods.RegistryTest do
  ...
  test "built-in mesh mailbox methods are registered" do
    assert {:ok, LemonControlPlane.Methods.MeshAgentMailboxList} =
             Registry.lookup("mesh.agent.mailbox.list")

    assert {:ok, LemonControlPlane.Methods.MeshAgentMailboxAck} =
             Registry.lookup("mesh.agent.mailbox.ack")

    assert {:ok, LemonControlPlane.Methods.MeshReplicationStatus} =
             Registry.lookup("mesh.replication.status")
  end
