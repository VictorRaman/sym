defmodule LemonCore.Quality.ArchitectureCheck do
  ...
  @app_namespaces %{
    ai: ["Ai"],
    coding_agent: ["AgentCore", "CodingAgent", "CodingAgent.UI", "LemonSkills"],
    lemon_control_plane: ["LemonControlPlane"],
    lemon_core: ["LemonCore", "LemonMesh"],
    lemon_gateway: ["LemonAutomation", "LemonChannels", "LemonGateway", "LemonRouter"]
  }

  @exact_module_owners %{
    "CodingAgent.UI" => :coding_agent,
    "CodingAgent.UI.Context" => :coding_agent,
    "CodingAgent.UI.RPC" => :coding_agent,
    "CodingAgent.UI.Headless" => :coding_agent,
    "CodingAgent.UI.DebugRPC" => :coding_agent
  }
