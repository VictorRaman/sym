defmodule LemonAutomation do
  @moduledoc """
  Compatibility facade for the absorbed automation subsystem inside
  `:lemon_gateway`.

  `LemonAutomation.*` remains the public module namespace for cron and heartbeat
  behavior, but it is no longer a standalone umbrella app. The implementation
  lives under `apps/lemon_gateway/lib/lemon_automation/`.
