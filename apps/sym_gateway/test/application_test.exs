defmodule LemonGateway.ApplicationTest do
  ...
  describe "Application startup sequence" do
    ...
    test "health server startup log can be silenced" do
      Application.put_env(:lemon_gateway, :health_enabled, true)
      Application.put_env(:lemon_gateway, :health_startup_log, false)
      stop_application()

      on_exit(fn ->
        Application.delete_env(:lemon_gateway, :health_startup_log)
      end)
      ...
      refute log =~ "Running LemonGateway.Health.Router"
    end
