...
Tool execution is handled in `apps/coding_agent/lib/agent_core/loop/tool_calls.ex`.
...
```elixir
# apps/coding_agent/lib/agent_core/loop.ex
...
File: `apps/coding_agent/lib/agent_core/application.ex`
...
```elixir
# apps/coding_agent/lib/agent_core/loop.ex, Lines 115-134
...
| Component | File Path |
|-----------|-----------|
| Tool execution loop | `apps/coding_agent/lib/agent_core/loop.ex` |
| Agent GenServer | `apps/coding_agent/lib/agent_core/agent.ex` |
| AgentCore supervisor | `apps/coding_agent/lib/agent_core/application.ex` |
| Event stream | `apps/coding_agent/lib/agent_core/event_stream.ex` |
