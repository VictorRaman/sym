...
- [ ] Encrypted secrets store as preferred secret access path [area:security] [status:planned] [impact:H] [effort:M] [updated:2026-02-23]
  ...
  - Next: Finish consolidating any remaining store-first secret resolution onto `LemonCore.Secrets.resolve/2`.
  - Refs: `apps/lemon_core/lib/lemon_core/secrets.ex`
...
- [ ] Skill lifecycle quality gates [area:lemon_skills] [status:idea] [impact:M] [effort:M] [updated:2026-02-22]
  ...
  - Refs: `apps/coding_agent/lib/lemon_skills/`, `docs/skills.md`
...
- [ ] Gateway/channel replay safety and idempotency [area:lemon_channels] [status:idea] [impact:H] [effort:M] [updated:2026-02-22]
  ...
  - Refs: `apps/lemon_gateway/lib/lemon_channels/`, `apps/lemon_gateway/`
...
- [ ] Cross-channel thread continuity model [area:product] [status:idea] [impact:M] [effort:L] [updated:2026-02-22]
  ...
  - Refs: `apps/lemon_gateway/lib/lemon_router/`, `apps/lemon_gateway/lib/lemon_channels/`
