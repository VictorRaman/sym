defmodule CodingAgent.ToolPolicyTest do
  ...
  describe "from_profile/1" do
    ...
    test "minimal_core allows core tools and excludes redundant ones" do
      ...
      assert ToolPolicy.allowed?(policy, "mesh_mailbox")
  ...
  describe "subagent_policy/2" do
    ...
    test "uses full access for local codex subagents on main sessions" do
      policy = ToolPolicy.subagent_policy(:codex, session_key: "agent:test:main")
    ...
    test "keeps codex subagents restricted for channel peer sessions" do
      policy =
        ToolPolicy.subagent_policy(
          :codex,
