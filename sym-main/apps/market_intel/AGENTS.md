...
> **Status:** `incubator`
> **Default runtime:** no
> **Keep reason:** experimental market-data and commentary product line; isolated from the default Lemon runtime and enabled only through explicit config

Shared umbrella defaults keep all ingestion/commentary feature flags disabled unless
