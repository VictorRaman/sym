defmodule LemonControlPlane.Application do
  ...
  defp server_child_spec do
    ...
    startup_log = Application.get_env(:lemon_control_plane, :startup_log, default_startup_log())

    {Bandit,
     plug: LemonControlPlane.HTTP.Router, port: port, scheme: :http, startup_log: startup_log}
  end
