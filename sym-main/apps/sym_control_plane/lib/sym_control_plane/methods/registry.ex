defmodule LemonControlPlane.Methods.Registry do
  ...
  @builtin_methods [
    ...
    LemonControlPlane.Methods.MeshSessionStart,
    LemonControlPlane.Methods.MeshSessionGet,
    LemonControlPlane.Methods.MeshSessionList,
    LemonControlPlane.Methods.MeshBlackboardGet,
    LemonControlPlane.Methods.MeshBlackboardAppend,
    LemonControlPlane.Methods.MeshAgentMessage,
    LemonControlPlane.Methods.MeshReplicationStatus,
    LemonControlPlane.Methods.MeshAgentMailboxList,
    LemonControlPlane.Methods.MeshAgentMailboxAck,
