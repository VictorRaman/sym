defmodule LemonCore.ConfigReloader.WatcherTest do
  ...
  defmodule IgnoreFileSystemStub do
  ...
  describe "init/1" do
    ...
    test "falls back to polling when the file_system module returns :ignore" do
      pid = start_watcher!(file_system_module: IgnoreFileSystemStub)
      state = :sys.get_state(pid)
