...
| [platform_tiers.md](platform_tiers.md) | Product-tier grading, runtime profile membership, and incubator status across umbrella apps |
...
| [mesh_runtime.md](mesh_runtime.md) | Lemon Mesh durable state, peer mailbox leases, and coding-agent runtime pull |
...
| `supervision-tree.excalidraw` / `.svg` | OTP supervision tree across all 19 applications |
