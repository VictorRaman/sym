...
| `ai` | `lemon_core` |
| `coding_agent` | `agent_core`, `ai`, `lemon_core`, `lemon_mesh`, `lemon_skills` |
| `coding_agent_ui` | `coding_agent` |
| `lemon_automation` | `lemon_core`, `lemon_router` |
| `lemon_channels` | `lemon_core` |
| `lemon_control_plane` | `ai`, `coding_agent`, `lemon_automation`, `lemon_channels`, `lemon_core`, `lemon_games`, `lemon_gateway`, `lemon_mesh`, `lemon_router`, `lemon_skills` |
| `lemon_core` | *(none)* |
